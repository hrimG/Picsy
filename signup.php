...
<?php
  $title = "Signup • Picsy";
  $keywords = "Picsy, Share and capture world's moments, share, capture, share, login, signup";
...
<div class="container">
  ...
  <div class="input_wrapper">
    <div class="signup-image" style="color: rgb(26, 24, 24); width:70%; padding-top: 100px;">
      <figure><img src="https://i.ibb.co/Bqy0Mf7/output-onlinepngtools-1.png" alt="sing up image">
      </figure>
		</div>
    ...
    <div class="sign_up_div">
      <form class="sign_up" id="sign_up" action="" method="post">
        ...
        <label for="s_terms" class="terms">I agree to <a href="terms" class="a_pri">Picsy Terms</a></label>
