...
<?php
  $title = "Thanks for registering • Picsy";
...
<html>
  <head>
    ...
    <meta name="author" content="Picsy, Pareka Fox">
...
<div class="badshah">
  ...
  <div class="about_div inst success_div">
    ...
    <div class="">
      ...
      <span>Picsy is hosted freely, so you'll find it bit slow, because hosting company has allowed limited requests per minute.</span>
